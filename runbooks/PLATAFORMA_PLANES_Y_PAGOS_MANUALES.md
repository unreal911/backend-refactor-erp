...
- Solo `platform.payments.approve` puede aprobarla; la acción queda auditada.
...
4. Programar la vigencia indicando el motivo.
...
4. Aprobar o rechazar indicando el motivo.
